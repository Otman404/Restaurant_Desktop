		...
		searchPlatsBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(frame,"Entrez le code du plat à rechercher");
			}
		});
		...
		searchCategBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(frame,"Entrez le code du categorie à rechercher");
			}
		});
		...
		searchServeursBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(frame,"Entrez l'ID du serveur à rechercher");
			}
		});
		...
		searchTablesBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(frame,"Entrez le numéro de la table à rechercher");
			}
		});
